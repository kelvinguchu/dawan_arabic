  ...
  if (!content) {
    return (
      <div className="my-8 p-6 bg-slate-50 border border-slate-200 rounded-lg text-center">
        <p className="text-slate-600">المحتوى المضمّن غير متوفر</p>
      </div>
    )
  }
        ...
        <div className="max-w-md mx-auto">
          <blockquote className="border border-gray-200 rounded-lg p-4 bg-gray-50 text-right">
            ...
            <cite className="text-sm text-gray-600">
              ...
              >
                عرض على X/تويتر <ExternalLink className="inline h-3 w-3 mr-1" />
              </a>
            </cite>
          </blockquote>
        </div>
...
const PDFBlock: React.FC<{
  ...
  if (!pdfUrl) {
    return (
      <div className="my-8 p-6 bg-slate-50 border border-slate-200 rounded-lg text-center">
        <p className="text-slate-600">مستند PDF غير متوفر</p>
      </div>
    )
  }
          ...
          {isMobile ? (
            ...
            <div className="p-8 text-center bg-slate-50">
              <div className="max-w-sm mx-auto">
                ...
                {!showDownloadButton && (
                  <p className="text-sm text-slate-500 italic">هذا المستند للعرض فقط</p>
                )}
              </div>
            </div>
          ) : (
            ...
            <div className="relative">
              ...
              <div className="hidden pdf-fallback absolute inset-0 p-8 text-center bg-white">
                ...
                <p className="text-slate-600 mb-4">متصفحك لا يدعم معاينة PDF.</p>
