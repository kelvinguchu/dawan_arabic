...
export const RichTextRenderer: React.FC<{ content: LexicalContent | string | null }> = ({
    ...
    return children.map((textNode: LexicalNode, i: number) => {
      ...
      if (textNode.type === 'link') {
        ...
        if (!isValidUrl(url)) {
          return (
            <span key={i}>
              {linkNode.children ? renderTextNodes(linkNode.children) : linkNode.text || 'رابط'}
            </span>
          )
        }
          ...
          switch (node.type) {
                ...
                return (
                  <h1 key={index} className="scroll-mt-24 group">
                    ...
                    >
                      ...
                      <span className="opacity-0 group-hover:opacity-100 mr-2 text-blue-500 transition-opacity">
                        #
                      </span>
                    </a>
                  </h1>
            ...
            case 'list': {
              ...
              return (
                <ListTag
                  key={index}
                  className={`my-4 mr-6 space-y-2 ${isOrderedList ? 'list-decimal' : 'list-disc'}`}
                >
                  {listNode.children &&
                              ...
                              listItem.children.map((childNode: LexicalNode, j: number) => {
                                ...
                                if (childNode.type === 'paragraph') {
                                  ...
                                  return (
                                    <NestedListTag
                                      key={j}
                                      className={`mt-2 mr-6 space-y-1 ${nestedIsOrdered ? 'list-decimal' : 'list-disc'}`}
                                    >
            ...
            case 'quote': {
              ...
              return (
                <blockquote
                  key={index}
                  className="relative pr-6 py-2 my-8 text-gray-700 border-r-4 border-blue-500 bg-blue-50/50 rounded-l-lg text-right"
                >
                  <Quote className="absolute right-4 top-4 text-blue-300/30 h-16 w-16 -z-10" />
            ...
            case 'listitem': {
              ...
              return (
                <li key={index} className="my-2 mr-6 list-disc">
                  ...
                  >
                    ...
                    <div className="bg-white">
                      <iframe
                        ...
                        height={600}
                        className="border-0"
                        title={uploadData.filename || 'المستند'}
                      >
                        <p>
                          متصفحك لا يدعم PDFs.
                          <a
            ...
            default:
              ...
              return <div key={index}>[نوع كتلة غير مدعوم: {node.type}]</div>
          }
        })}
      </div>
    )
  ...
  return (
    <div className="article-content">
      <p className="text-gray-700 italic">[خطأ في الهيكلية — لا يمكن عرض المحتوى]</p>
    </div>
  )
}
