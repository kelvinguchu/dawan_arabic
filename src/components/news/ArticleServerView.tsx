          ...
          <div className="max-w-3xl mx-auto bg-white rounded-t-2xl -mt-2 sm:-mt-10 pt-6 sm:pt-10 pb-8 sm:pb-16 px-4 sm:px-8 md:px-12 shadow-sm relative z-10 article-content">
            <div className="mb-6 sm:mb-8 pb-6 border-b border-gray-100">
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
                <div className="flex items-start gap-2 sm:gap-3 flex-1 order-1 sm:order-2 flex-row-reverse">
                  <div className="shrink-0">
                    {(() => {
                          ...
                          return (
                            <div className="relative w-6 h-6 sm:w-7 sm:h-7 rounded-full overflow-hidden">
                              <Image
                                ...
                                alt={`صورة ملف شخصي لـ ${getPostAuthorName(post)}`}
                                fill
                      ...
                      return <UserCircle className="h-6 w-6 sm:h-7 text-primary" />
                    })()}
                  </div>
            ...
            {post.layout && post.layout.length > 0 ? (
              ...
              <div className="prose prose-sm sm:prose-base lg:prose-lg max-w-none text-gray-800 text-right">
                <p>هذا المقال لا يحتوي على محتوى بعد.</p>
              </div>
            )}
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row-reverse sm:justify-between gap-3 mb-8">
                <Link
                  href="/news"
                  className="px-6 py-3 bg-primary hover:bg-primary/80 transition-colors text-white font-medium rounded-lg text-center sm:text-right"
                >
                  مقالات إضافية
                </Link>
                <BackToTopButton className="px-6 py-3 bg-white hover:bg-gray-50 transition-colors text-primary font-medium border border-gray-200 rounded-lg text-center sm:text-right">
                  العودة للأعلى
                </BackToTopButton>
              </div>
