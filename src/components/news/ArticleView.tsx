        ...
        <div className="bg-gray-50 py-6 sm:py-8 md:py-12 mt-6 sm:mt-8 border-t border-gray-100">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
              <div className="flex flex-wrap items-center justify-between gap-y-4 mb-6 sm:mb-8 flex-row-reverse">
                <div className="flex flex-wrap items-center gap-3 sm:gap-4 flex-row-reverse">
                  <button
                  ...
                  >
                    ...
                    <span className="text-sm font-medium">
                      {isFavorited ? 'تم الحفظ' : 'حفظ'} ({currentFavoriteCount})
                    </span>
                  </button>
