  ...
  return (
    <form onSubmit={handleFormSubmit} className={`flex items-center gap-2 ${className}`}>
      ...
      <Button
        ...
        className={`${buttonClassName} ${isHeaderSearch ? 'rounded-full bg-primary hover:bg-primary/80' : 'bg-primary hover:bg-primary/80'}`}
      >
        <Search
          className={`${isHeaderSearch ? 'h-4 w-4' : 'h-5 w-5'} text-secondary`}
        />
