...
export const HeroSection: React.FC<HeroSectionProps> = ({ latestPost, recentPosts, flashNews }) => {
    ...
    return (
      <section className="py-4">
        <div className="container mx-auto px-4">
          <Card>
            <CardContent className="p-6">
              <p className="text-gray-500 font-sans text-right">
                لا توجد أخبار مميزة في الوقت الحالي.
              </p>
            </CardContent>
          </Card>
        </div>
  ...
  return (
    <section className="bg-linear-to-b from-slate-100 to-white py-4 sm:py-6 font-sans">
      <div className="container mx-auto px-4">
