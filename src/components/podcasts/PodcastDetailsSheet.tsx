  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      ...
      >
        <SheetHeader>
          <VisuallyHidden>
            <SheetTitle>{displayTitle} - تفاصيل البودكاست</SheetTitle>
          </VisuallyHidden>
        </SheetHeader>
              ...
              <div className="relative h-64 overflow-hidden">
                {coverImageUrl ? (
                  <>
                    ...
                    />
                    <div className="absolute inset-0 bg-linear-to-br from-primary/90 via-primary/60 to-black/80" />
              ...
              <div className="px-6 space-y-8">
                ...
                <div className="flex gap-4">
                  <Button
                    variant="outline"
                    size="icon"
                    className="h-14 w-14 border-2 border-primary/30 text-primary hover:bg-primary/80 hover:border-primary/50 rounded-2xl transition-all duration-300"
                  >
                ...
                {peopleInvolved && peopleInvolved.trim() !== '' && (
                  <div className="relative overflow-hidden bg-linear-to-br from-slate-50 via-white to-slate-50/50 p-6 rounded-3xl border border-slate-200/60">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-primary/5 rounded-full -translate-y-16 translate-x-16"></div>
                    <div className="flex items-start gap-4 relative z-10">
                      <div className="w-12 h-12 bg-linear-to-br from-primary to-primary/80 rounded-2xl flex items-center justify-center shrink-0">
                ...
                <div className="bg-linear-to-br from-slate-900 via-slate-800 to-slate-900 p-6 rounded-3xl text-white">
                  ...
                  <div className="grid grid-cols-1 gap-3 text-base">
                    ...
                    {Number(podcast.playCount) > 0 && (
                      <div className="flex justify-between items-center py-2 border-b border-slate-700/50">
                        <span className="text-slate-400">مرات الاستماع</span>
                        <span className="font-semibold text-white">
                          {Number(podcast.playCount).toLocaleString()}
                        </span>
                      </div>
                    ...
                    {podcast.episodeNumber && (
                      <div className="flex justify-between items-center py-2">
                        <span className="text-slate-400">رقم الحلقة</span>
