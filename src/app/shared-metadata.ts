...
export const siteConfig = {
  ...
  url: process.env.NODE_ENV === 'production' ? 'https://bawaba.africa' : 'http://localhost:3000',
  themeColor: '#b01c14',
}
...
export const sharedMetadata: Metadata = {
  ...
  authors: [{ name: 'بوابة أفريقيا', url: siteConfig.url }],
  creator: 'بوابة أفريقيا',
  publisher: 'بوابة أفريقيا',
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
