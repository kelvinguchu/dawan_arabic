...
function verifyUnsubscribeTokenAndExtractEmail(token: string): {
  isValid: boolean
  email?: string
} {
  ...
  try {
    ...
    return { isValid, email: isValid ? tokenEmail : undefined }
  } catch (error) {
...
<head>
    ...
    <title>Invalid Unsubscribe Link - بوابة أفريقيا</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div style="margin-top: 30px;">
            <a href="https://bawaba.africa" class="btn">Visit Our Website</a>
            <a href="mailto:info@bawaba.africa" class="btn">Contact Support</a>
        </div>
    </div>
</body>
</html>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Email Not Found - بوابة أفريقيا</title>
    <style>
        body {
            font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;
            background-color: #f8f9fa;
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Successfully Unsubscribed - بوابة أفريقيا</title>
    <style>
        body {
            font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;
            background-color: #f8f9fa;
...
<body>
    <div class="container">
        ...
        <p style="font-size: 14px; color: #999; margin-top: 30px;">
            ...
            <a href="mailto:info@bawaba.africa" style="color: #b01c14;">info@bawaba.africa</a>
        </p>
    </div>
</body>
</html>
