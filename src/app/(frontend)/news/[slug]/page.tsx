...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!post) {
    return {
      ...sharedMetadata,
      title: 'لم يتم العثور على المقال | بوابة أفريقيا',
    }
  }
  ...
  return {
    ...
    twitter: {
      ...
      description:
        excerpt ||
        'Akhri maqaal xiiso leh oo ka mid ah بوابة أفريقيا — il lagu kalsoonaan karo oo warar iyo aragtiyo ka bixisa Soomaaliya.',
      images: [ogImageUrl],
    },
    alternates: {
