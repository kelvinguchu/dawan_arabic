...
export async function generateMetadata({
  ...
  const baseTitle = 'الأخبار | بوابة أفريقيا - آخر أخبار الصومال'
  const baseDescription =
    'تابع آخر أخبار الصومال. تغطية متعمقة للسياسة، الأعمال، التكنولوجيا، الثقافة والمزيد — مع التركيز على الصومال.'

  const title = reporterName ? `مقالات بقلم ${reporterName} | بوابة أفريقيا` : baseTitle
  const description = reporterName
    ? `تصفح جميع المقالات التي كتبها ${reporterName}. تغطية متعمقة لأخبار الصومال.`
    : baseDescription
